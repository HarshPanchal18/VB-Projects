...
Public Class Login
    Private Sub Btnlogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btnlogin.Click
        ...
        con.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source= C:\Users\HP\source\repos\Carrentalsystem\Carrentalsystem\bin\Debug\Carrental.accdb"

        Dim cmd As OleDbCommand = New OleDbCommand(
                   "SELECT * FROM tbladmin WHERE ADMIN_USER = '" &
